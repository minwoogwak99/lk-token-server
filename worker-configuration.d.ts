/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e99db9c63f845059faaaaac9f0580b62)
// Runtime types generated with workerd@1.20250913.0 2025-09-13 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		AGENTS_KV: KVNamespace;
		DEFAULT_AGENT_NAME: "air-voice-agent-BB";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEFAULT_AGENT_NAME" | "LIVEKIT_API_KEY" | "LIVEKIT_API_SECRET" | "LIVEKIT_URL" | "CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY">> {}
}
